 ...
 * vec_right4_ps(v1,v2)
 */
/*MACROS vec_left et vec_right qui me servent dans le fichier .c*/
#define vec_left1_ps(v0, v1)  _mm_shuffle_ps(v0,vec_left2_ps(v0, v1),_MM_SHUFFLE(2,1,2,1))
#define vec_left2_ps(v0, v1)  _mm_shuffle_ps(v0,v1,_MM_SHUFFLE(1,0,3,2))
#define vec_left3_ps(v0, v1)  v0
#define vec_left4_ps(v0, v1)  v0

#define vec_right1_ps(v1, v2) _mm_shuffle_ps(vec_right2_ps(v1, v2),v2,_MM_SHUFFLE(2,1,2,1))
#define vec_right2_ps(v1, v2) _mm_shuffle_ps(v1,v2,_MM_SHUFFLE(1,0,3,2))
