...
/* -------------------- */
{
    ...
    routine_generate_sample(128-8/2,  128+8/2,  "carre8",  dst_path); puts("");
    routine_generate_sample(128-16/2, 128+16/2, "carre16", dst_path); puts("");
    routine_generate_sample(128-32/2, 128+32/2, "carre32", dst_path); puts("");
    routine_generate_sample(128-64/2, 128+64/2, "carre64", dst_path); puts("");
}
/* --------------------------------------------------------------------- */
...
/* ------------------------ */
{
    ...
    //routine_gaussian_noise(src_path, "boat", dst_path); puts("");
...
/* ------------------------------------------ */
{
    ...
    // fonctions de bruitage des images
    test_gaussian_noise();
    test_impulse_noise();
